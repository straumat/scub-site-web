    ...
    copy: {
      ...
      dev: {
        files: [
          ...
          //{expand: true, cwd: 'src/assets/vendor/ionicons/fonts', src: ['**'], dest: 'src/assets/fonts/'},
          //{expand: true, cwd: 'src/assets/vendor/material-icons/fonts', src: ['**'], dest: 'src/assets/fonts/'},
          //{expand: true, cwd: 'src/assets/vendor/pe-icon-7-stroke/fonts', src: ['**'], dest: 'src/assets/fonts/'},
          //{expand: true, cwd: 'src/assets/vendor/i8-icon', src: ['i8-icons.svg'], dest: 'src/assets/fonts/'},
          //{expand: true, cwd: 'src/assets/vendor/emojione', src: ['*.svg'], dest: 'src/assets/fonts/'}
          //{expand: true, cwd: 'src/assets/vendor/summernote/font', src: ['**'], dest: 'src/assets/fonts/'},
          //{expand: true, cwd: 'src/assets/vendor/dropify/fonts', src: ['**'], dest: 'src/assets/fonts/'},
          //{expand: true, cwd: 'src/assets/vendor/jquery.filer/assets/fonts/jquery.filer-icons', src: ['**', '!*.css', '!*.html'], dest: 'src/assets/fonts/'}
        ]
      }
    },
